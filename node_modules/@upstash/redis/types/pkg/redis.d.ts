import { CommandOptions, DelCommand, ExistsCommand, FlushAllCommand, JsonGetCommand, MGetCommand, PingCommand, ScoreMember, ScriptExistsCommand, SetCommandOptions, TouchCommand, UnlinkCommand, ZAddCommandOptions, ZAddCommandOptionsWithIncr, ZRangeCommandOptions } from "@upstash/redis/types/pkg/commands/mod.js";
import { Requester, UpstashRequest, UpstashResponse } from "@upstash/redis/types/pkg/http.js";
import { Pipeline } from "@upstash/redis/types/pkg/pipeline.js";
import type { CommandArgs } from "@upstash/redis/types/pkg/types.js";
import { Script } from "@upstash/redis/types/pkg/script.js";
import type { RedisOptions, Telemetry } from "@upstash/redis/types/pkg/types.js";
export type { RedisOptions } from "@upstash/redis/types/pkg/types.js";
/**
...
export declare class Redis {
     ...
     */
    hscan: (key: string, cursor: number, cmdOpts?: import("@upstash/redis/types/pkg/commands/scan.js").ScanCommandOptions | undefined) => Promise<[number, (string | number)[]]>;
    /**
     ...
     */
    scan: (cursor: number, opts?: import("@upstash/redis/types/pkg/commands/scan.js").ScanCommandOptions | undefined) => Promise<[number, string[]]>;
    /**
     ...
     */
    scriptFlush: (opts?: import("@upstash/redis/types/pkg/commands/script_flush.js").ScriptFlushCommandOptions | undefined) => Promise<"OK">;
    /**
     ...
     */
    sscan: (key: string, cursor: number, opts?: import("@upstash/redis/types/pkg/commands/scan.js").ScanCommandOptions | undefined) => Promise<[number, (string | number)[]]>;
    /**
     ...
     */
    type: (key: string) => Promise<import("@upstash/redis/types/pkg/commands/type.js").Type>;
    /**
     ...
     */
    zinterstore: (destination: string, numKeys: number, keys: string[], opts?: import("@upstash/redis/types/pkg/commands/zinterstore.js").ZInterStoreCommandOptions | undefined) => Promise<number>;
    /**
     ...
     */
    zscan: (key: string, cursor: number, opts?: import("@upstash/redis/types/pkg/commands/scan.js").ScanCommandOptions | undefined) => Promise<[number, (string | number)[]]>;
    /**
     ...
     */
    zunionstore: (destination: string, numKeys: number, keys: string[], opts?: import("@upstash/redis/types/pkg/commands/zunionstore.js").ZUnionStoreCommandOptions | undefined) => Promise<number>;
}
