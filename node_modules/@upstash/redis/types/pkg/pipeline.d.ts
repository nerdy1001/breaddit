import { BitOpCommand, DelCommand, ExistsCommand, FlushAllCommand, JsonGetCommand, MGetCommand, PingCommand, ScoreMember, ScriptExistsCommand, SetCommandOptions, TouchCommand, UnlinkCommand, ZAddCommandOptions, ZAddCommandOptionsWithIncr, ZRangeCommandOptions } from "@upstash/redis/types/pkg/commands/mod.js";
import { Command, CommandOptions } from "@upstash/redis/types/pkg/commands/command.js";
import { Requester } from "@upstash/redis/types/pkg/http.js";
import { CommandArgs } from "@upstash/redis/types/pkg/types.js";
...
export declare class Pipeline<TCommands extends Command<any, any>[] = []> {
     ...
     */
    hscan: (key: string, cursor: number, cmdOpts?: import("@upstash/redis/types/pkg/commands/scan.js").ScanCommandOptions | undefined) => Pipeline<[...TCommands, Command<any, [number, (string | number)[]]>]>;
    /**
     ...
     */
    scan: (cursor: number, opts?: import("@upstash/redis/types/pkg/commands/scan.js").ScanCommandOptions | undefined) => Pipeline<[...TCommands, Command<any, [number, string[]]>]>;
    /**
     ...
     */
    scriptFlush: (opts?: import("@upstash/redis/types/pkg/commands/script_flush.js").ScriptFlushCommandOptions | undefined) => Pipeline<[...TCommands, Command<any, "OK">]>;
    /**
     ...
     */
    sscan: (key: string, cursor: number, opts?: import("@upstash/redis/types/pkg/commands/scan.js").ScanCommandOptions | undefined) => Pipeline<[...TCommands, Command<any, [number, (string | number)[]]>]>;
    /**
     ...
     */
    type: (key: string) => Pipeline<[...TCommands, Command<any, import("@upstash/redis/types/pkg/commands/type.js").Type>]>;
    /**
     ...
     */
    zinterstore: (destination: string, numKeys: number, keys: string[], opts?: import("@upstash/redis/types/pkg/commands/zinterstore.js").ZInterStoreCommandOptions | undefined) => Pipeline<[...TCommands, Command<any, number>]>;
    /**
     ...
     */
    zscan: (key: string, cursor: number, opts?: import("@upstash/redis/types/pkg/commands/scan.js").ScanCommandOptions | undefined) => Pipeline<[...TCommands, Command<any, [number, (string | number)[]]>]>;
    /**
     ...
     */
    zunionstore: (destination: string, numKeys: number, keys: string[], opts?: import("@upstash/redis/types/pkg/commands/zunionstore.js").ZUnionStoreCommandOptions | undefined) => Pipeline<[...TCommands, Command<any, number>]>;
    /**
