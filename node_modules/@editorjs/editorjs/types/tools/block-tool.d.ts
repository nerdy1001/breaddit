import { ConversionConfig, PasteConfig, SanitizerConfig } from '@editorjs/editorjs/types/configs';
import { BlockToolData } from '@editorjs/editorjs/types/tools/block-tool-data';
import { BaseTool, BaseToolConstructable } from '@editorjs/editorjs/types/tools/tool';
import { ToolConfig } from '@editorjs/editorjs/types/tools/tool-config';
import { API, BlockAPI, ToolboxConfig } from '@editorjs/editorjs';
import { PasteEvent } from '@editorjs/editorjs/types/tools/paste-events';
import { MoveEvent } from '@editorjs/editorjs/types/tools/hook-events';
